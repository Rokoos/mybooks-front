...
import { errorMessage, charNumber, bookCategories } from "../utils";
import {
  MDBContainer,
  MDBRow,
  MDBCol,
...
export default class NewPost extends Component {
  ...
  isValid = () => {
    const { author, title, body, fileSize, category } = this.state;
    ...
    return (
      <MDBContainer>
        {loading ? (
          ...
          this.renderForm(author, title, body, error, photo)
        )}
      </MDBContainer>
    );
  }
